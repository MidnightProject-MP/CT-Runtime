...
| A8. Stable durable identity references | Durable objects retain required project ID, thread/conversation ID where applicable, Work Unit ID, Execution ID, authority-decision/reference ID, and fence/claim generation | Stage 2 — Kernel | Persistence/reload assertions for all identity/ref fields across lifecycle transitions | Stage 2 | Open |
