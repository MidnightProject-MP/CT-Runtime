...
export function createExecutionEvidence(input = {}) {
  if (!input.evidenceId || !input.physicalExecutionId) throw new Error('evidenceId and physicalExecutionId are required');
...
export function validateExecutionEvidence(value) {
  ...
  if (typeof value.evidenceId !== 'string' || typeof value.physicalExecutionId !== 'string') throw new Error('evidence identity is required');
