...
export function createNeonStore({ connectionString, pool, applicationName = 'ct-runtime-vnext', authorizationVerifier = null } = {}) {
  ...
  async function beginExecution(workUnit, execution, authorizationDecision = null) {
    ...
    try {
      ...
      const authorityInserted = await client.query('INSERT INTO vnext_project_mutation_authority(project_id,work_unit_id,execution_id,fence,owner,claim_expires_at,authorization_decision_ref) VALUES ($1,$2,$3,$4,$5,$6) ON CONFLICT DO NOTHING RETURNING *', [execution.project_id, workUnit.work_unit_id, execution.execution_id, execution.fence, execution.owner, execution.claim_expires_at, execution.authorization_decision_ref]);
